<?php
	...
	function db_insert_dupe($table, $fields, $fields2){
		...
		$ret = db_query("INSERT INTO {$table} ($k) VALUES ($v) ON DUPLICATE KEY UPDATE {$set}", $bind);
	...
	function db_update($table, $fields, $where, $bind=array()){
